...
public class Scimcq2 extends AppCompatActivity {
    ImageView Opt1,Opt2,Opt3,Opt4;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scimcq2);
        ...
        Opt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                startActivity(new Intent(Scimcq2.this,Scimcq3.class));
            }
        });
        ...
        Opt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Opt2.setImageResource(R.drawable.redcircle);
                startActivity(new Intent(Scimcq2.this,Scimcq3.class));
            }
        });
