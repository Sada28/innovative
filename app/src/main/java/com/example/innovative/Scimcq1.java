...
public class Scimcq1 extends AppCompatActivity {
    ImageView Opt1,Opt2,Opt3,Opt4;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scimcq1);
        ...
        Opt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                startActivity(new Intent(Scimcq1.this,Scimcq2.class));
            }
        });
        ...
        Opt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                Opt3.setImageResource(R.drawable.redcircle);
                startActivity(new Intent(Scimcq1.this,Scimcq2.class));
            }
        });
